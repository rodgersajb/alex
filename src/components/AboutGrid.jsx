    ...
    <div className="flex-col">
      <div className="flex-container">
        ...
        <div className="text-container">
          <p>
            Not the Vin Diesel thing. Happily married to my amazing wife, Steph
            with whom we have two amazing boys, Noah and Mason.
          </p>
        </div>
      </div>
      <div className="flex-container">
      ...
      <div className="text-container">
        <p>
          Fascinated with learning how things work. My transition into tech has
          taught me to explore often and learn constantly.
        </p>
      </div>
      <div className="flex-container">
        <div className="content">
